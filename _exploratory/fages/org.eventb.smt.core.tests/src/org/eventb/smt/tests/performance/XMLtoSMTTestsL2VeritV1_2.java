...
public class XMLtoSMTTestsL2VeritV1_2 extends XMLtoSMTTests {
	public XMLtoSMTTestsL2VeritV1_2(final LemmaData data) {
		super(data, VERIT, L2, V1_2, !GET_UNSAT_CORE);
	}
