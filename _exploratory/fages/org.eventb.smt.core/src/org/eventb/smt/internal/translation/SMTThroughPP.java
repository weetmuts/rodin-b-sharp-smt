...
import static org.eventb.smt.internal.ast.SMTFactory.makeBool;
import static org.eventb.smt.internal.ast.SMTFactory.makeInteger;
import static org.eventb.smt.internal.ast.attributes.SMTLabel.GOAL_LABEL;
import static org.eventb.smt.internal.ast.symbols.SMTFunctionSymbol.ASSOCIATIVE;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.DIV;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.EXPN;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.GE;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.GT;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.LE;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.LT;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.MINUS;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.MOD;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.MUL;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.PLUS;
import static org.eventb.smt.internal.ast.theories.SMTLogic.SMTOperator.UMINUS;
...
import org.eventb.smt.internal.ast.SMTBenchmarkPP;
...
import org.eventb.smt.internal.ast.SMTSignatureV1_2PP;
import org.eventb.smt.internal.ast.SMTSignatureV2_0;
import org.eventb.smt.internal.ast.SMTSignatureV2_0PP;
import org.eventb.smt.internal.ast.SMTTerm;
import org.eventb.smt.internal.ast.SMTVar;
import org.eventb.smt.internal.ast.attributes.SMTLabel;
...
import org.eventb.smt.internal.ast.theories.ISMTArithmeticBoolFuns;
import org.eventb.smt.internal.ast.theories.ISMTArithmeticFuns;
